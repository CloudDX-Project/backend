...
@Component
public class TouristLodgingLicenseClient {
    ...
    public TouristLodgingLicenseClient(
            @Value("${external.accommodation.base-url}") String baseUrl,
            @Value("${external.accommodation.tourist-lodging.path}") String path,
            @Value("${external.accommodation.tourist-lodging.service-key}") String serviceKey
    ) {
    ...
    public record Item(
            ...
            @JsonProperty("TOUR_LDGBIZ_DTL_NM")
            String touristLodgingType,

            @JsonProperty("TELNO")
            String telephone,

            @JsonProperty("GSRM_CNT")
            String guestRoomCount
